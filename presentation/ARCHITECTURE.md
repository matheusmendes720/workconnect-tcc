...
### Busca Full-Text
- Nomes de produtos (FULLTEXT)
- Nomes de clientes (FULLTEXT)
- Nomes de fornecedores (FULLTEXT)

### Compostos
- (data_venda, status) para vendas
- (produto_id, data_hora) para movimentações
...
### Vantagens
- Visualização clara do modelo
- Exportação de diagramas de alta qualidade
- Forward engineering (modelo → SQL)
- Reverse engineering (banco → modelo)
...
- Modelo Conceitual: `erd/conceptual/`
- Modelo Lógico: `erd/logical/`
- MySQL Workbench: `erd/mysql-workbench/`
