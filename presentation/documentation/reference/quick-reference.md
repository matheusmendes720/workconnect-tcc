...
- `database/schema/schema.sql` - Schema completo
- `database/schema/triggers.sql` - Triggers
- `database/schema/views.sql` - Views
- `database/schema/seed.sql` - Dados de exemplo
...
SOURCE database/schema/triggers.sql;
SOURCE database/schema/views.sql;
SOURCE database/schema/seed.sql;
```
